    ...
    >
      <div className="card-glass h-full overflow-hidden hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-blue-200/50">
        ...
        <div className="p-6">
          ...
          {/* Title */}
          <h3 className="text-lg font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-blue-700 transition-colors duration-300 leading-tight">
            {issue.title}
          </h3>
          ...
          <div className="flex items-center text-gray-600 text-sm mb-4">
            ...
            <span className="truncate font-medium">{`${issue.location.coordinates[1].toFixed(4)}, ${issue.location.coordinates[0].toFixed(4)}`}</span>
          </div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-100">
            ...
            <div className="flex items-center space-x-4">
              <motion.div 
                className="flex items-center text-gray-600 hover:text-red-500 transition-colors group/like cursor-pointer"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
              >
              ...
              <motion.div 
                className="flex items-center text-gray-600 hover:text-blue-500 transition-colors group/comment cursor-pointer"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.95 }}
              >
            ...
            <div className="flex items-center text-gray-500 text-sm">
              ...
              <span className="font-medium">{formatDistanceToNow(new Date(issue.createdAt), { addSuffix: true })}</span>
            </div>
          </div>
