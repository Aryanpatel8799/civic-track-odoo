      ...
      <motion.nav
        ...
        className={cn(
          ...
          isScrolled 
            ...
            : "bg-white/85 backdrop-blur-xl border-b border-white/20"
        )}
      >
        ...
        {isOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute right-0 top-0 h-full w-80 bg-white/98 backdrop-blur-2xl shadow-2xl border-l border-gray-200/50"
            >
